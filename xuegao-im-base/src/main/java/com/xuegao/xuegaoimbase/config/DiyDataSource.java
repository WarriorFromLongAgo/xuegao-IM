 ...
 * <br/> @ClassName：DataSource
 * <br/> @Description：
 * <br/> @author：xuegao
 * <br/> @date：2020/11/21 12:23
 */
public class DiyDataSource {
    ...
    @Primary
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") javax.sql.DataSource dataSource) throws Exception {
